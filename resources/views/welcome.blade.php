...
@section("header")
    ...
    <header class="header text-center text-white"
            style="background-image: linear-gradient(-225deg, #800080 0%, #800080 48%, #000000 100%">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-8 mx-auto">
                    ...
                    <p class="lead-2 opacity-90 mt-6">Read and get updated on how programmers progress</p>
